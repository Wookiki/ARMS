...
public class VolunteerUserContentBoardAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Article conArticle = boardContentService.getVolunteerConArticle(num);		
		request.setAttribute("conArticle", conArticle);
		request.setAttribute("pageNum", pageNum);
		ActionForward forward = new ActionForward();
		forward.setUrl("volunteerUserContentBoard.jsp");
