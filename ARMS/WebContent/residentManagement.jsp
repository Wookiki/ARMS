...
<head>
    ...
    <!-- bootstrap -->
    <link href="residentManagement/bootstrap.css" rel="stylesheet" />

    <!-- libraries -->
    <link href="residentManagement/font-awesome.css" type="text/css" rel="stylesheet" />

    <!-- global styles -->
    <link rel="stylesheet" type="text/css" href="residentManagement/layout.css">
    <link rel="stylesheet" type="text/css" href="residentManagement/elements.css">
...
<body>
	...
	<!-- global scripts -->
	<script src="residentManagement/jquery.js"></script>
	<script src="residentManagement/bootstrap.js"></script>
	
	<!-- this page specific scripts -->

	
	<!-- theme scripts -->
	<script src="residentManagement/scripts.js"></script>
